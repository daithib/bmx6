...
static int32_t link_status_creator(struct status_handl *handl, void *data)
{
        ...
        struct link_status *status = ((struct link_status*) (handl->data = debugReallocReset(handl->data, max_size, -300358)));
...
static int32_t orig_status_creator(struct status_handl *handl, void *data)
{
        ...
        uint32_t i = 0;
        struct orig_status *status = ((struct orig_status*) (handl->data = debugReallocReset(handl->data, status_size, -300366)));
