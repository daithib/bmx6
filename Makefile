...
SRC_C =  bmx.c crypt.c sec.c msg.c z.c metrics.c tools.c plugin.c list.c allocate.c avl.c iid.c hna.c control.c schedule.c ip.c
SRC_H =  bmx.h crypt.h sec.h msg.h z.h metrics.h tools.h plugin.h list.h allocate.h avl.h iid.h hna.h control.h schedule.h ip.h
